...
function $s_Lscalatags_generic_InputAttrs$class__checked__Lscalatags_generic_InputAttrs__Lscalatags_generic_AttrPair($$this) {
  var this$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr($$this, "checked", null, false);
...
function $s_Lscalatags_generic_Styles$TextAlign$class__right__Lscalatags_generic_Styles$TextAlign__Lscalatags_generic_StylePair($$this) {
  return $as_Lscalatags_generic_Style($$this).$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("right", new $c_Lscalatags_JsDom$GenericStyle().init___())
}
...
function $s_sc_TraversableOnce$class__min__sc_TraversableOnce__s_math_Ordering__O($$this, cmp) {
  ...
  return $$this.reduceLeft__F2__O(new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($$this$1, cmp$1) {
    return (function(x$2, y$2) {
      return ($s_s_math_Ordering$class__lteq__s_math_Ordering__O__O__Z(cmp$1, x$2, y$2) ? x$2 : y$2)
    })
  })($$this, cmp)))
}
...
$c_Lobservatory_Interaction2$.prototype.init___ = (function() {
  $n_Lobservatory_Interaction2$ = this;
  this.colors$1 = $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O(60.0, new $c_Lobservatory_Color().init___I__I__I(255, 255, 255)), new $c_T2().init___O__O(32.0, new $c_Lobservatory_Color().init___I__I__I(255, 0, 0)), new $c_T2().init___O__O(12.0, new $c_Lobservatory_Color().init___I__I__I(255, 255, 0)), new $c_T2().init___O__O(0.0, new $c_Lobservatory_Color().init___I__I__I(0, 255, 255)), new $c_T2().init___O__O((-15.0), new $c_Lobservatory_Color().init___I__I__I(0, 0, 255)), new $c_T2().init___O__O((-27.0), new $c_Lobservatory_Color().init___I__I__I(255, 0, 255)), new $c_T2().init___O__O((-50.0), new $c_Lobservatory_Color().init___I__I__I(33, 0, 107)), new $c_T2().init___O__O((-60.0), new $c_Lobservatory_Color().init___I__I__I(0, 0, 0))])));
  this.colors2$1 = $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O(7.0, new $c_Lobservatory_Color().init___I__I__I(0, 0, 0)), new $c_T2().init___O__O(4.0, new $c_Lobservatory_Color().init___I__I__I(255, 0, 0)), new $c_T2().init___O__O(2.0, new $c_Lobservatory_Color().init___I__I__I(255, 255, 0)), new $c_T2().init___O__O(0.0, new $c_Lobservatory_Color().init___I__I__I(255, 255, 255)), new $c_T2().init___O__O((-2.0), new $c_Lobservatory_Color().init___I__I__I(0, 255, 255)), new $c_T2().init___O__O((-7.0), new $c_Lobservatory_Color().init___I__I__I(0, 0, 255))])));
  return this
});
$c_Lobservatory_Interaction2$.prototype.yearSelection__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, sliderValue) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$2, sliderValue$1) {
    return (function() {
      var range = $as_Lobservatory_Layer(selectedLayer$2.apply__O()).bounds$1;
      var index = $uI(sliderValue$1.apply__O());
      return ((index < range.min__s_math_Ordering__I($m_s_math_Ordering$Int$())) ? range.min__s_math_Ordering__I($m_s_math_Ordering$Int$()) : ((index > range.max__s_math_Ordering__I($m_s_math_Ordering$Int$())) ? range.max__s_math_Ordering__I($m_s_math_Ordering$Int$()) : index))
    })
  })(selectedLayer, sliderValue));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
$c_Lobservatory_Interaction2$.prototype.availableLayers__sc_Seq = (function() {
  return $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Temperatures$(), this.colors$1, new $c_sci_Range$Inclusive().init___I__I__I(1975, 2015, 1)), new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Deviations$(), this.colors2$1, new $c_sci_Range$Inclusive().init___I__I__I(1990, 2015, 1))])))
});
$c_Lobservatory_Interaction2$.prototype.yearBounds__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer) {
  $m_Lobservatory_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$1) {
    return (function() {
      return $as_Lobservatory_Layer(selectedLayer$1.apply__O()).bounds$1
    })
  })(selectedLayer));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
$c_Lobservatory_Interaction2$.prototype.layerUrlPattern__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  $m_Lobservatory_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$3, selectedYear$1) {
    return (function() {
      var layer = $as_Lobservatory_Layer(selectedLayer$3.apply__O()).layerName$1.id$1;
      var year = $uI(selectedYear$1.apply__O());
      return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["target/", "/", "/{z}/{x}-{y}.png"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([layer, year]))
    })
...
$c_Lobservatory_Interaction2$.prototype.caption__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  $m_Lobservatory_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$4, selectedYear$2) {
    return (function() {
      var layerName = $as_Lobservatory_Layer(selectedLayer$4.apply__O()).layerName$1;
      var year = $uI(selectedYear$2.apply__O());
      return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", " (", ")"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([layerName, year]))
    })
  })(selectedLayer, selectedYear));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
...
var $n_Lobservatory_Interaction2$ = (void 0);
function $m_Lobservatory_Interaction2$() {
  if ((!$n_Lobservatory_Interaction2$)) {
    $n_Lobservatory_Interaction2$ = new $c_Lobservatory_Interaction2$().init___()
  };
...
$c_Lobservatory_LayerName.prototype.init___T = (function(id) {
  this.id$1 = id;
  return this
});
/** @constructor */
function $c_Lobservatory_Signal() {
  $c_O.call(this);
  this.observatory$Signal$$myExpr$1 = null;
  this.myValue$1 = null;
  this.observatory$Signal$$observers$1 = null;
...
$c_Lobservatory_Signal.prototype.init___F0 = (function(expr) {
  this.observatory$Signal$$observers$1 = $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  this.observed$1 = $m_sci_Nil$();
  this.update__F0__V(expr);
  return this
});
$c_Lobservatory_Signal.prototype.update__F0__V = (function(expr) {
  this.observatory$Signal$$myExpr$1 = expr;
  this.computeValue__V()
});
$c_Lobservatory_Signal.prototype.apply__O = (function() {
  this.observatory$Signal$$observers$1 = $as_sci_Set(this.observatory$Signal$$observers$1.$$plus__O__sc_Set($m_Lobservatory_Signal$().caller$1.v$1));
  var assertion = (!$as_Lobservatory_Signal($m_Lobservatory_Signal$().caller$1.v$1).observatory$Signal$$observers$1.contains__O__Z(this));
  if ((!assertion)) {
    throw new $c_jl_AssertionError().init___O("assertion failed: cyclic signal definition")
  };
  var ev$1 = $as_Lobservatory_Signal($m_Lobservatory_Signal$().caller$1.v$1);
...
$c_Lobservatory_Signal.prototype.computeValue__V = (function() {
  ...
  while ((!these.isEmpty__Z())) {
    ...
    sig.observatory$Signal$$observers$1 = $as_sci_Set(sig.observatory$Signal$$observers$1.$$minus__O__sc_Set(this));
    var this$2 = these;
    these = this$2.tail__sci_List()
  };
  this.observed$1 = $m_sci_Nil$();
  var this$3 = $m_Lobservatory_Signal$().caller$1;
  var oldval = this$3.v$1;
  this$3.v$1 = this;
  try {
    var newValue = this.observatory$Signal$$myExpr$1.apply__O()
  } finally {
    this$3.v$1 = oldval
  };
  this.myValue$1 = newValue;
  var obs = this.observatory$Signal$$observers$1;
  this.observatory$Signal$$observers$1 = $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
...
function $is_Lobservatory_Signal(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lobservatory_Signal)))
}
function $as_Lobservatory_Signal(obj) {
  return (($is_Lobservatory_Signal(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "observatory.Signal"))
}
...
$h_Lobservatory_Signal$.prototype = $c_Lobservatory_Signal$.prototype;
$c_Lobservatory_Signal$.prototype.init___ = (function() {
  $n_Lobservatory_Signal$ = this;
  this.caller$1 = new $c_s_util_DynamicVariable().init___O($m_Lobservatory_NoSignal$());
  return this
});
var $d_Lobservatory_Signal$ = new $TypeData().initClass({
  Lobservatory_Signal$: 0
...
$c_Lobservatory_Signal$.prototype.$classData = $d_Lobservatory_Signal$;
var $n_Lobservatory_Signal$ = (void 0);
function $m_Lobservatory_Signal$() {
  if ((!$n_Lobservatory_Signal$)) {
    $n_Lobservatory_Signal$ = new $c_Lobservatory_Signal$().init___()
  };
...
/** @constructor */
function $c_Lscalatags_DataConverters$CssNumber() {
  $c_O.call(this);
  this.x$1 = null;
  this.$$outer$f = null
}
...
$c_Lscalatags_DataConverters$CssNumber.prototype.em__T = (function() {
  ...
  var self = this.x$1;
  return jsx$1.$$plus$extension__O__T__T(self, "em")
});
$c_Lscalatags_DataConverters$CssNumber.prototype.init___Lscalatags_DataConverters__O__s_math_Numeric = (function($$outer, x, evidence$1) {
  this.x$1 = x;
  if (($$outer === null)) {
...
$c_Lscalatags_DataConverters$CssNumber.prototype.px__T = (function() {
  var jsx$1 = $m_s_Predef$any2stringadd$();
  var self = this.x$1;
  return jsx$1.$$plus$extension__O__T__T(self, "px")
});
...
$c_Lobservatory_JSMain$.prototype.init___ = (function() {
  return this
});
$c_Lobservatory_JSMain$.prototype.makeRadioButtons__sc_Seq__T2 = (function(availableLayers) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(initialValue$1) {
    return (function() {
      return initialValue$1
    })
  })(initialValue));
  var radioButtonValue = new $c_Lobservatory_Var().init___F0(expr);
  var jsx$10 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().div__Lscalatags_generic_TypedTag());
  var jsx$9 = $m_Lscalatags_JsDom$styles$().position__Lscalatags_generic_Styles$position$().absolute__Lscalatags_generic_StylePair();
  var jsx$8 = $m_Lscalatags_JsDom$styles$().top__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lobservatory_Implicits$().intPixelStyle$1);
  var jsx$7 = $m_Lscalatags_JsDom$styles$().right__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lobservatory_Implicits$().intPixelStyle$1);
  var jsx$6 = $m_Lscalatags_JsDom$styles$().left__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lobservatory_Implicits$().intPixelStyle$1);
  var jsx$5 = $m_Lscalatags_JsDom$styles$().height__Lscalatags_generic_StyleMisc$PixelAutoStyle();
  var this$2 = $m_Lobservatory_Implicits$();
  var jsx$4 = jsx$10.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$9, jsx$8, jsx$7, jsx$6, jsx$5.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$2, 2, $m_s_math_Numeric$IntIsIntegral$()).em__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1), $m_Lscalatags_JsDom$styles$().zIndex__Lscalatags_generic_StyleMisc$AutoStyle().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair(1500, $m_Lobservatory_Implicits$().intStyle$1)]));
  var this$5 = $m_Lobservatory_Implicits$();
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(initialValue$1$1, radioButtonValue$1) {
    return (function(layer$2) {
      var layer = $as_Lobservatory_Layer(layer$2);
      var jsx$3 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().label__Lscalatags_generic_TypedTag());
      var jsx$2 = $m_Lobservatory_JSMain$().observatory$JSMain$$makeRadioButton$1__Lobservatory_Layer__Lobservatory_Layer__Lobservatory_Var__Lscalatags_generic_Frag(layer, initialValue$1$1, radioButtonValue$1);
      $m_Lobservatory_Implicits$();
      var v = layer.layerName$1.toString__T();
      return jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$2, new $c_Lscalatags_JsDom$StringFrag().init___T(v)]))
    })
  })(initialValue, radioButtonValue));
  var this$4 = $m_sc_Seq$();
  var xs = $as_sc_Seq(availableLayers.map__F1__scg_CanBuildFrom__O(jsx$1, this$4.ReusableCBFInstance$2));
  var ev = $m_s_Predef$().singleton$und$less$colon$less$2;
  var root = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$Cap$SeqFrag().init___Lscalatags_JsDom$Cap__sc_Seq__F1(this$5, xs, ev)]));
  return new $c_T2().init___O__O(root, radioButtonValue)
});
$c_Lobservatory_JSMain$.prototype.observatory$JSMain$$render$1__O__F1__Lorg_scalajs_dom_raw_Node = (function(a, aToFrag$1) {
  return $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().span__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lscalatags_generic_Modifier(aToFrag$1.apply__O__O(a))])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lobservatory_JSMain$.prototype.makeCaptionElement__Lobservatory_Signal__Lscalatags_generic_Frag = (function(selectedLayer) {
  $m_Lobservatory_Signal$();
  var expr = new $c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1().init___Lobservatory_Signal(selectedLayer);
  var signalA = new $c_Lobservatory_Signal().init___F0(expr);
  var aToFrag = $m_s_Predef$().singleton$und$less$colon$less$2;
  var a = signalA.apply__O();
  var elem = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().span__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lscalatags_generic_Modifier(a)])).render__Lorg_scalajs_dom_raw_Element();
  var last = new $c_sr_ObjectRef().init___O(elem);
  $m_Lobservatory_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(signalA$1, aToFrag$1, last$1) {
    return (function() {
      var current = $m_Lobservatory_JSMain$().observatory$JSMain$$render$1__O__F1__Lorg_scalajs_dom_raw_Node(signalA$1.apply__O(), aToFrag$1);
      last$1.elem$1.replaceChild(current, last$1.elem$1.firstChild);
      last$1.elem$1 = current
    })
  })(signalA, aToFrag, last));
  new $c_Lobservatory_Signal().init___F0(expr$1);
  var this$4 = $m_Lobservatory_Implicits$();
  var e = last.elem$1;
  return new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$4, e)
});
$c_Lobservatory_JSMain$.prototype.main__V = (function() {
  ...
  var radioButtonElement = $as_Lscalatags_generic_Frag(x1.$$und1$f);
  var selectedLayer = $as_Lobservatory_Signal(x1.$$und2$f);
  var x1$2 = this.makeSlider__Lobservatory_Signal__T2(selectedLayer);
  if ((x1$2 === null)) {
    throw new $c_s_MatchError().init___O(x1$2)
  };
  var sliderElement = $as_Lscalatags_generic_Frag(x1$2.$$und1$f);
  var selectedYear = $as_Lobservatory_Signal(x1$2.$$und2$f);
  ...
  var app = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([radioButtonElement, sliderElement, captionElement]));
...
$c_Lobservatory_JSMain$.prototype.observatory$JSMain$$makeRadioButton$1__Lobservatory_Layer__Lobservatory_Layer__Lobservatory_Var__Lscalatags_generic_Frag = (function(layer, initialValue$1, radioButtonValue$1) {
  var jsx$7 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().input__Lscalatags_generic_TypedTag());
  var jsx$6 = $m_Lscalatags_JsDom$attrs$().type__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("radio", $m_Lobservatory_Implicits$().stringAttr$1);
  var jsx$5 = $m_Lscalatags_JsDom$attrs$().name__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("layer", $m_Lobservatory_Implicits$().stringAttr$1);
  var jsx$4 = $m_Lscalatags_JsDom$attrs$().onclick__Lscalatags_generic_Attr();
  var jsx$3 = new $c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1().init___Lobservatory_Var__Lobservatory_Layer(radioButtonValue$1, layer);
  var this$1 = $m_Lobservatory_Implicits$();
  var ev = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(f$2) {
    var f = $as_F1(f$2);
    return (function(f$1) {
  ...
  var jsx$2 = jsx$4.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$3, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$1, ev));
  if (((layer === null) ? (initialValue$1 === null) : layer.equals__O__Z(initialValue$1))) {
    var this$2 = $m_Lobservatory_Implicits$();
    var xs = new $c_s_Some().init___O($m_Lscalatags_JsDom$attrs$().checked__Lscalatags_generic_AttrPair());
    var ev$1 = $m_s_Predef$().singleton$und$less$colon$less$2;
    var this$4 = xs.toList__sci_List();
    var jsx$1 = new $c_Lscalatags_generic_Util$SeqNode().init___Lscalatags_generic_Util__sc_Seq__F1(this$2, this$4, ev$1)
  } else {
    var this$6 = $m_Lobservatory_Implicits$();
    var xs$1 = $m_s_None$();
    var ev$2 = $m_s_Predef$().singleton$und$less$colon$less$2;
    var this$8 = xs$1.toList__sci_List();
    var jsx$1 = new $c_Lscalatags_generic_Util$SeqNode().init___Lscalatags_generic_Util__sc_Seq__F1(this$6, this$8, ev$2)
  };
  return jsx$7.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$6, jsx$5, jsx$2, jsx$1]))
});
$c_Lobservatory_JSMain$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lobservatory_JSMain$.prototype.makeSlider__Lobservatory_Signal__T2 = (function(selectedLayer) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(yearBounds$1) {
    return (function() {
      return $as_sci_Range(yearBounds$1.apply__O()).max__s_math_Ordering__I($m_s_math_Ordering$Int$())
    })
  })(yearBounds));
  var sliderValue = new $c_Lobservatory_Var().init___F0(expr);
  $m_Lobservatory_Signal$();
  var expr$1 = new $c_Lobservatory_JSMain$$anonfun$4().init___Lobservatory_Signal__Lobservatory_Var(yearBounds, sliderValue);
  var input = new $c_Lobservatory_Signal().init___F0(expr$1);
  ...
  $m_Lobservatory_Signal$();
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(captionSignal$1) {
    return (function() {
      var jsx$1 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().span__Lscalatags_generic_TypedTag());
      $m_Lobservatory_Implicits$();
      var v = $as_T(captionSignal$1.apply__O());
      return jsx$1.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$StringFrag().init___T(v)]))
    })
  })(captionSignal));
  var caption = new $c_Lobservatory_Signal().init___F0(expr$2);
  var jsx$10 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().div__Lscalatags_generic_TypedTag());
  var jsx$9 = $m_Lscalatags_JsDom$styles$().position__Lscalatags_generic_Styles$position$().absolute__Lscalatags_generic_StylePair();
  var jsx$8 = $m_Lscalatags_JsDom$styles$().bottom__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lobservatory_Implicits$().intPixelStyle$1);
  var jsx$7 = $m_Lscalatags_JsDom$styles$().right__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lobservatory_Implicits$().intPixelStyle$1);
  var jsx$6 = $m_Lscalatags_JsDom$styles$().left__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lobservatory_Implicits$().intPixelStyle$1);
  var jsx$5 = $m_Lscalatags_JsDom$styles$().height__Lscalatags_generic_StyleMisc$PixelAutoStyle();
  var this$5 = $m_Lobservatory_Implicits$();
  var jsx$4 = jsx$10.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$9, jsx$8, jsx$7, jsx$6, jsx$5.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$5, 2, $m_s_math_Numeric$IntIsIntegral$()).em__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1), $m_Lscalatags_JsDom$styles$().zIndex__Lscalatags_generic_StyleMisc$AutoStyle().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair(1500, $m_Lobservatory_Implicits$().intStyle$1)]));
  var jsx$3 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().label__Lscalatags_generic_TypedTag());
  var aToFrag = $m_s_Predef$().singleton$und$less$colon$less$2;
  var a = input.apply__O();
  var elem = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().span__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lscalatags_generic_Modifier(a)])).render__Lorg_scalajs_dom_raw_Element();
  var last = new $c_sr_ObjectRef().init___O(elem);
  $m_Lobservatory_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(signalA$1, aToFrag$1, last$1) {
    return (function() {
      var current = $m_Lobservatory_JSMain$().observatory$JSMain$$render$1__O__F1__Lorg_scalajs_dom_raw_Node(signalA$1.apply__O(), aToFrag$1);
      last$1.elem$1.replaceChild(current, last$1.elem$1.firstChild);
      last$1.elem$1 = current
  ...
  new $c_Lobservatory_Signal().init___F0(expr$3);
  var this$8 = $m_Lobservatory_Implicits$();
  var e = last.elem$1;
  var jsx$2 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$8, e);
  var aToFrag$2 = $m_s_Predef$().singleton$und$less$colon$less$2;
  var a$1 = caption.apply__O();
  var elem$1 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().span__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lscalatags_generic_Modifier(a$1)])).render__Lorg_scalajs_dom_raw_Element();
  var last$2 = new $c_sr_ObjectRef().init___O(elem$1);
  $m_Lobservatory_Signal$();
  var expr$4 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(signalA$1$1, aToFrag$1$1, last$1$1) {
    return (function() {
      var current$1 = $m_Lobservatory_JSMain$().observatory$JSMain$$render$1__O__F1__Lorg_scalajs_dom_raw_Node(signalA$1$1.apply__O(), aToFrag$1$1);
      last$1$1.elem$1.replaceChild(current$1, last$1$1.elem$1.firstChild);
      last$1$1.elem$1 = current$1
    })
  })(caption, aToFrag$2, last$2));
  new $c_Lobservatory_Signal().init___F0(expr$4);
  var this$11 = $m_Lobservatory_Implicits$();
  var e$1 = last$2.elem$1;
  var root = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$2, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$11, e$1)]))]));
  return new $c_T2().init___O__O(root, selectedYear)
});
$c_Lobservatory_JSMain$.prototype.setupMap__Lobservatory_Signal__Lobservatory_Signal__V = (function(selectedLayer, selectedYear) {
  var mapElement = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$styles$().height__Lscalatags_generic_StyleMisc$PixelAutoStyle().$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair("100%", $m_Lobservatory_Implicits$().stringPixelStyle$1)])).render__Lorg_scalajs_dom_raw_Element();
  var map = $g.L.map(mapElement, new $c_Lleaflet_MapOptions().init___Z__I(false, 3));
  map.setView($g.L.latLng(48.0, 14.0), 3);
  $g.L.tileLayer("https://maps.wikimedia.org/osm-intl/{z}/{x}/{y}.png").addTo(map);
  ...
  var layer = $g.L.tileLayer($as_T(urlSignal.apply__O()));
  layer.addTo(map);
  $m_Lobservatory_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(urlSignal$1, layer$1) {
    return (function() {
  ...
  var jsx$1 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body;
  var this$2 = $m_Lobservatory_Implicits$();
  jsx$1.appendChild(new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$2, mapElement).e$1);
  map.invalidateSize()
});
$c_Lobservatory_JSMain$.prototype.main = (function() {
...
var $n_Lobservatory_JSMain$ = (void 0);
function $m_Lobservatory_JSMain$() {
  if ((!$n_Lobservatory_JSMain$)) {
    $n_Lobservatory_JSMain$ = new $c_Lobservatory_JSMain$().init___()
  };
  return $n_Lobservatory_JSMain$
}
$e.observatory = ($e.observatory || {});
$e.observatory.JSMain = $m_Lobservatory_JSMain$;
/** @constructor */
function $c_Lobservatory_NoSignal$() {
  $c_Lobservatory_Signal.call(this)
}
...
$c_Lobservatory_NoSignal$.prototype.init___ = (function() {
  $c_Lobservatory_Signal.prototype.init___F0.call(this, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
...
var $n_Lobservatory_NoSignal$ = (void 0);
function $m_Lobservatory_NoSignal$() {
  if ((!$n_Lobservatory_NoSignal$)) {
    $n_Lobservatory_NoSignal$ = new $c_Lobservatory_NoSignal$().init___()
  };
  return $n_Lobservatory_NoSignal$
}
/** @constructor */
function $c_Lobservatory_Var() {
  $c_Lobservatory_Signal.call(this)
}
...
$c_Lobservatory_Var.prototype.init___F0 = (function(expr) {
  $c_Lobservatory_Signal.prototype.init___F0.call(this, expr);
  return this
});
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lleaflet_MapOptions() {
  $c_O.call(this);
  this.zoomControl$1 = false;
  this.maxZoom$1 = 0
}
...
$c_Lleaflet_MapOptions.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lleaflet_MapOptions(x$1)) {
    var MapOptions$1 = $as_Lleaflet_MapOptions(x$1);
    return ((this.zoomControl$1 === MapOptions$1.zoomControl$1) && (this.maxZoom$1 === MapOptions$1.maxZoom$1))
  } else {
    return false
  }
});
...
$c_Lleaflet_MapOptions.prototype.$$js$exported$prop$zoomControl__O = (function() {
  return this.zoomControl$1
});
$c_Lleaflet_MapOptions.prototype.init___Z__I = (function(zoomControl, maxZoom) {
  this.zoomControl$1 = zoomControl;
  this.maxZoom$1 = maxZoom;
  return this
});
$c_Lleaflet_MapOptions.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, (this.zoomControl$1 ? 1231 : 1237));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.maxZoom$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Lleaflet_MapOptions.prototype.$$js$exported$prop$maxZoom__O = (function() {
  return this.maxZoom$1
});
$c_Lleaflet_MapOptions.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
Object.defineProperty($c_Lleaflet_MapOptions.prototype, "maxZoom", {
  "get": (function() {
    return this.$$js$exported$prop$maxZoom__O()
  }),
  "enumerable": true
});
Object.defineProperty($c_Lleaflet_MapOptions.prototype, "zoomControl", {
  "get": (function() {
    return this.$$js$exported$prop$zoomControl__O()
  }),
  "enumerable": true
});
function $is_Lleaflet_MapOptions(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lleaflet_MapOptions)))
}
function $as_Lleaflet_MapOptions(obj) {
  return (($is_Lleaflet_MapOptions(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "leaflet.MapOptions"))
}
...
$c_Lobservatory_Color.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lobservatory_Color(x$1)) {
    var Color$1 = $as_Lobservatory_Color(x$1);
    return (((this.red$1 === Color$1.red$1) && (this.green$1 === Color$1.green$1)) && (this.blue$1 === Color$1.blue$1))
  } else {
    return false
  }
});
$c_Lobservatory_Color.prototype.init___I__I__I = (function(red, green, blue) {
  this.red$1 = red;
  this.green$1 = green;
  this.blue$1 = blue;
  return this
...
$c_Lobservatory_Color.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.red$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.green$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.blue$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 3)
});
$c_Lobservatory_Color.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lobservatory_Color(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lobservatory_Color)))
}
function $as_Lobservatory_Color(obj) {
  return (($is_Lobservatory_Color(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "observatory.Color"))
}
...
/** @constructor */
function $c_Lobservatory_JSMain$$anonfun$4() {
  $c_sr_AbstractFunction0.call(this);
  this.yearBounds$1$2 = null;
  this.sliderValue$1$f = null
}
$c_Lobservatory_JSMain$$anonfun$4.prototype = new $h_sr_AbstractFunction0();
$c_Lobservatory_JSMain$$anonfun$4.prototype.constructor = $c_Lobservatory_JSMain$$anonfun$4;
/** @constructor */
function $h_Lobservatory_JSMain$$anonfun$4() {
  /*<skip>*/
}
$h_Lobservatory_JSMain$$anonfun$4.prototype = $c_Lobservatory_JSMain$$anonfun$4.prototype;
$c_Lobservatory_JSMain$$anonfun$4.prototype.init___Lobservatory_Signal__Lobservatory_Var = (function(yearBounds$1, sliderValue$1) {
  this.yearBounds$1$2 = yearBounds$1;
  this.sliderValue$1$f = sliderValue$1;
  return this
});
$c_Lobservatory_JSMain$$anonfun$4.prototype.apply__O = (function() {
  return this.apply__Lscalatags_JsDom$TypedTag()
});
$c_Lobservatory_JSMain$$anonfun$4.prototype.apply__Lscalatags_JsDom$TypedTag = (function() {
  var jsx$10 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().input__Lscalatags_generic_TypedTag());
  var jsx$9 = $m_Lscalatags_JsDom$attrs$().type__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("range", $m_Lobservatory_Implicits$().stringAttr$1);
  var jsx$8 = $m_Lscalatags_JsDom$attrs$().min__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair($as_sci_Range(this.yearBounds$1$2.apply__O()).min__s_math_Ordering__I($m_s_math_Ordering$Int$()), $m_Lobservatory_Implicits$().intAttr$1);
  var jsx$7 = $m_Lscalatags_JsDom$attrs$().max__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair($as_sci_Range(this.yearBounds$1$2.apply__O()).max__s_math_Ordering__I($m_s_math_Ordering$Int$()), $m_Lobservatory_Implicits$().intAttr$1);
  var jsx$6 = $m_Lscalatags_JsDom$attrs$().value__Lscalatags_generic_Attr();
  var a$1 = $as_sci_Range(this.yearBounds$1$2.apply__O()).min__s_math_Ordering__I($m_s_math_Ordering$Int$());
  var a = $uI(this.sliderValue$1$f.apply__O());
  var b = $as_sci_Range(this.yearBounds$1$2.apply__O()).max__s_math_Ordering__I($m_s_math_Ordering$Int$());
  var b$1 = ((a < b) ? a : b);
  var jsx$5 = jsx$6.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(((a$1 > b$1) ? a$1 : b$1), $m_Lobservatory_Implicits$().intAttr$1);
  var jsx$4 = $m_Lscalatags_JsDom$attrs$().onchange__Lscalatags_generic_Attr();
  var jsx$3 = new $c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3().init___Lobservatory_JSMain$$anonfun$4(this);
  ...
  var jsx$2 = jsx$4.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$3, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$3, ev));
  var jsx$1 = $m_Lscalatags_JsDom$styles$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle();
  var this$4 = $m_Lobservatory_Implicits$();
  return jsx$10.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$9, jsx$8, jsx$7, jsx$5, jsx$2, jsx$1.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$4, 40, $m_s_math_Numeric$IntIsIntegral$()).em__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1)]))
});
var $d_Lobservatory_JSMain$$anonfun$4 = new $TypeData().initClass({
  Lobservatory_JSMain$$anonfun$4: 0
}, false, "observatory.JSMain$$anonfun$4", {
  Lobservatory_JSMain$$anonfun$4: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lobservatory_JSMain$$anonfun$4.prototype.$classData = $d_Lobservatory_JSMain$$anonfun$4;
/** @constructor */
function $c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype = new $h_sr_AbstractFunction1();
$c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype.constructor = $c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3;
/** @constructor */
function $h_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3() {
  /*<skip>*/
}
$h_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype = $c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype;
$c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype.apply__O__O = (function(v1) {
  this.apply__Lorg_scalajs_dom_raw_Event__V(v1)
});
$c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype.init___Lobservatory_JSMain$$anonfun$4 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype.apply__Lorg_scalajs_dom_raw_Event__V = (function(ev) {
  var input = ev.target;
  var this$5 = this.$$outer$2.sliderValue$1$f;
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(input$1) {
    return (function() {
      var x = $as_T(input$1.value);
      var this$2 = new $c_sci_StringOps().init___T(x);
      var this$4 = $m_jl_Integer$();
      var $$this = this$2.repr$1;
      return this$4.parseInt__T__I__I($$this, 10)
    })
  })(input));
  $c_Lobservatory_Signal.prototype.update__F0__V.call(this$5, expr)
});
var $d_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3 = new $TypeData().initClass({
  Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3: 0
}, false, "observatory.JSMain$$anonfun$4$$anonfun$apply$3", {
  Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3.prototype.$classData = $d_Lobservatory_JSMain$$anonfun$4$$anonfun$apply$3;
/** @constructor */
function $c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1() {
  $c_sr_AbstractFunction0.call(this);
  this.selectedLayer$1$2 = null
}
$c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype = new $h_sr_AbstractFunction0();
$c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype.constructor = $c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1;
/** @constructor */
function $h_Lobservatory_JSMain$$anonfun$makeCaptionElement$1() {
  /*<skip>*/
}
$h_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype = $c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype;
$c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype.init___Lobservatory_Signal = (function(selectedLayer$1) {
  this.selectedLayer$1$2 = selectedLayer$1;
  return this
});
$c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype.apply__O = (function() {
  return this.apply__Lscalatags_JsDom$TypedTag()
});
$c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype.apply__Lscalatags_JsDom$TypedTag = (function() {
  var jsx$17 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().div__Lscalatags_generic_TypedTag());
  var jsx$16 = $m_Lscalatags_JsDom$styles$().position__Lscalatags_generic_Styles$position$().absolute__Lscalatags_generic_StylePair();
  var jsx$15 = $m_Lscalatags_JsDom$styles$().top__Lscalatags_generic_StyleMisc$PixelAutoStyle();
  var this$1 = $m_Lobservatory_Implicits$();
  var jsx$14 = jsx$15.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$1, 5, $m_s_math_Numeric$IntIsIntegral$()).px__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1);
  var jsx$13 = $m_Lscalatags_JsDom$styles$().right__Lscalatags_generic_StyleMisc$PixelAutoStyle();
  var this$2 = $m_Lobservatory_Implicits$();
  var jsx$12 = jsx$17.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$16, jsx$14, jsx$13.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$2, 5, $m_s_math_Numeric$IntIsIntegral$()).px__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1), $m_Lscalatags_JsDom$styles$().zIndex__Lscalatags_generic_StyleMisc$AutoStyle().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair(1500, $m_Lobservatory_Implicits$().intStyle$1), $m_Lscalatags_JsDom$styles$().backgroundColor__Lscalatags_generic_Style().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("white", $m_Lobservatory_Implicits$().stringStyle$1)]));
  var this$8 = $m_Lobservatory_Implicits$();
  var jsx$11 = $as_sc_TraversableLike($as_Lobservatory_Layer(this.selectedLayer$1$2.apply__O()).colorScale$1.reverse__O()).withFilter__F1__scg_FilterMonadic(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(check$ifrefutable$1$2) {
    var check$ifrefutable$1 = $as_T2(check$ifrefutable$1$2);
    if ((check$ifrefutable$1 !== null)) {
      var p2 = $as_Lobservatory_Color(check$ifrefutable$1.$$und2$f);
      if ((p2 !== null)) {
        return true
      }
    };
  ...
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$3$2) {
    ...
    if ((x$3 !== null)) {
      var t = $uD(x$3.$$und1$f);
      var p2$1 = $as_Lobservatory_Color(x$3.$$und2$f);
      if ((p2$1 !== null)) {
        var red = p2$1.red$1;
        var green = p2$1.green$1;
        var blue = p2$1.blue$1;
        var jsx$10 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().div__Lscalatags_generic_TypedTag());
        var jsx$9 = $m_Lscalatags_JsDom$styles$().margin__Lscalatags_generic_Styles$margin$();
        var this$3 = $m_Lobservatory_Implicits$();
        var jsx$8 = jsx$10.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$9.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$3, 5, $m_s_math_Numeric$IntIsIntegral$()).px__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1), $m_Lscalatags_JsDom$styles$().textAlign__Lscalatags_generic_Styles$TextAlign().right__Lscalatags_generic_StylePair()]));
        var jsx$7 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().span__Lscalatags_generic_TypedTag());
        $m_Lobservatory_Implicits$();
        var v = ((((t > 0) ? "+" : "") + t) + " ");
        var jsx$6 = jsx$7.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$StringFrag().init___T(v)]));
        var jsx$5 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$tags$().span__Lscalatags_generic_TypedTag());
        var jsx$4 = $m_Lscalatags_JsDom$styles$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle();
        var this$5 = $m_Lobservatory_Implicits$();
        var jsx$3 = jsx$4.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$5, 20, $m_s_math_Numeric$IntIsIntegral$()).px__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1);
        var jsx$2 = $m_Lscalatags_JsDom$styles$().height__Lscalatags_generic_StyleMisc$PixelAutoStyle();
        var this$6 = $m_Lobservatory_Implicits$();
        return jsx$8.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$6, jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, jsx$2.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(new $c_Lscalatags_DataConverters$CssNumber().init___Lscalatags_DataConverters__O__s_math_Numeric(this$6, 15, $m_s_math_Numeric$IntIsIntegral$()).px__T(), $m_Lobservatory_Implicits$().stringPixelStyle$1), $m_Lscalatags_JsDom$styles$().backgroundColor__Lscalatags_generic_Style().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["rgb(", ", ", ", ", ")"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([red, green, blue])), $m_Lobservatory_Implicits$().stringStyle$1), $m_Lscalatags_JsDom$styles$().display__Lscalatags_generic_Styles$display$().inline$minusblock__Lscalatags_generic_StylePair(), $m_Lscalatags_JsDom$styles$().border__Lscalatags_generic_Style().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("thin solid black", $m_Lobservatory_Implicits$().stringStyle$1)]))]))
      }
    };
    throw new $c_s_MatchError().init___O(x$3)
  }));
  var this$7 = $m_sc_Seq$();
  var xs = $as_sc_Seq(jsx$11.map__F1__scg_CanBuildFrom__O(jsx$1, this$7.ReusableCBFInstance$2));
  var ev = $m_s_Predef$().singleton$und$less$colon$less$2;
  return jsx$12.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$Cap$SeqFrag().init___Lscalatags_JsDom$Cap__sc_Seq__F1(this$8, xs, ev)]))
});
var $d_Lobservatory_JSMain$$anonfun$makeCaptionElement$1 = new $TypeData().initClass({
  Lobservatory_JSMain$$anonfun$makeCaptionElement$1: 0
}, false, "observatory.JSMain$$anonfun$makeCaptionElement$1", {
  Lobservatory_JSMain$$anonfun$makeCaptionElement$1: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lobservatory_JSMain$$anonfun$makeCaptionElement$1.prototype.$classData = $d_Lobservatory_JSMain$$anonfun$makeCaptionElement$1;
/** @constructor */
function $c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1() {
  $c_sr_AbstractFunction1.call(this);
  this.radioButtonValue$1$2 = null;
  this.layer$2$f = null
}
$c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype = new $h_sr_AbstractFunction1();
$c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype.constructor = $c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1;
/** @constructor */
function $h_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1() {
  /*<skip>*/
}
$h_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype = $c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype;
$c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype.apply__O__O = (function(v1) {
  this.apply__Lorg_scalajs_dom_raw_Event__V(v1)
});
$c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype.init___Lobservatory_Var__Lobservatory_Layer = (function(radioButtonValue$1, layer$2) {
  this.radioButtonValue$1$2 = radioButtonValue$1;
  this.layer$2$f = layer$2;
  return this
});
$c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype.apply__Lorg_scalajs_dom_raw_Event__V = (function(ev) {
  var input = ev.target;
  if ($uZ(input.checked)) {
    var this$1 = this.radioButtonValue$1$2;
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
      return (function() {
        return arg$outer.layer$2$f
      })
    })(this));
    $c_Lobservatory_Signal.prototype.update__F0__V.call(this$1, expr)
  }
});
var $d_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1 = new $TypeData().initClass({
  Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1: 0
}, false, "observatory.JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1", {
  Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1.prototype.$classData = $d_Lobservatory_JSMain$$anonfun$observatory$JSMain$$makeRadioButton$1$1;
/** @constructor */
function $c_Lobservatory_Layer() {
  $c_O.call(this);
  this.layerName$1 = null;
  this.colorScale$1 = null;
  this.bounds$1 = null
}
...
$c_Lobservatory_Layer.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lobservatory_Layer(x$1)) {
    var Layer$1 = $as_Lobservatory_Layer(x$1);
    var x = this.layerName$1;
    var x$2 = Layer$1.layerName$1;
    if ((x === x$2)) {
      var x$3 = this.colorScale$1;
      var x$4 = Layer$1.colorScale$1;
      var jsx$1 = ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      var jsx$1 = false
    };
    if (jsx$1) {
      var x$5 = this.bounds$1;
      var x$6 = Layer$1.bounds$1;
...
$c_Lobservatory_Layer.prototype.init___Lobservatory_LayerName__sc_Seq__sci_Range = (function(layerName, colorScale, bounds) {
  this.layerName$1 = layerName;
  this.colorScale$1 = colorScale;
...
function $is_Lobservatory_Layer(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lobservatory_Layer)))
}
function $as_Lobservatory_Layer(obj) {
  return (($is_Lobservatory_Layer(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "observatory.Layer"))
}
...
$c_Lscalatags_generic_PixelStyle.prototype.$$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair = (function(v, ev) {
  ...
  return ev.apply__Lscalatags_generic_Style__O__Lscalatags_generic_StylePair(this.realStyle$1, v)
});
...
$c_Lscalatags_generic_Style.prototype.$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair = (function(v, ev) {
  ...
  return new $c_Lscalatags_generic_StylePair().init___Lscalatags_generic_Style__O__Lscalatags_generic_StyleValue(this, v, ev)
});
...
function $c_Lobservatory_LayerName$Deviations$() {
  $c_Lobservatory_LayerName.call(this)
}
...
$c_Lobservatory_LayerName$Deviations$.prototype.init___ = (function() {
  $c_Lobservatory_LayerName.prototype.init___T.call(this, "deviations");
  return this
});
...
var $n_Lobservatory_LayerName$Deviations$ = (void 0);
function $m_Lobservatory_LayerName$Deviations$() {
  if ((!$n_Lobservatory_LayerName$Deviations$)) {
    $n_Lobservatory_LayerName$Deviations$ = new $c_Lobservatory_LayerName$Deviations$().init___()
  };
...
$c_Lobservatory_LayerName$Temperatures$.prototype.init___ = (function() {
  $c_Lobservatory_LayerName.prototype.init___T.call(this, "temperatures");
  return this
});
...
var $n_Lobservatory_LayerName$Temperatures$ = (void 0);
function $m_Lobservatory_LayerName$Temperatures$() {
  if ((!$n_Lobservatory_LayerName$Temperatures$)) {
    $n_Lobservatory_LayerName$Temperatures$ = new $c_Lobservatory_LayerName$Temperatures$().init___()
  };
...
/** @constructor */
function $c_Lscalatags_generic_Styles$display$() {
  $c_Lscalatags_generic_Style.call(this);
  this.none$2 = null;
  this.inline$2 = null;
  this.block$2 = null;
  this.list$minusitem$2 = null;
  this.inline$minusblock$2 = null;
  this.inline$minustable$2 = null;
  this.table$2 = null;
  this.table$minuscaption$2 = null;
  this.table$minuscell$2 = null;
  this.table$minuscolumn$2 = null;
  this.table$minuscolumn$minusgroup$2 = null;
  this.table$minusfooter$minusgroup$2 = null;
  this.table$minusheader$minusgroup$2 = null;
  this.table$minusrow$2 = null;
  this.table$minusrow$minusgroup$2 = null;
  this.flex$2 = null;
  this.inline$minusflex$2 = null;
  this.$$outer$2 = null;
  this.bitmap$0$2 = 0
}
...
$c_Lscalatags_generic_Styles$display$.prototype.inline$minusblock__Lscalatags_generic_StylePair = (function() {
  return (((16 & this.bitmap$0$2) === 0) ? this.inline$minusblock$lzycompute__p2__Lscalatags_generic_StylePair() : this.inline$minusblock$2)
});
$c_Lscalatags_generic_Styles$display$.prototype.init___Lscalatags_generic_Styles = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  $c_Lscalatags_generic_Style.prototype.init___T__T.call(this, "display", "display");
  return this
});
$c_Lscalatags_generic_Styles$display$.prototype.inline$minusblock$lzycompute__p2__Lscalatags_generic_StylePair = (function() {
  if (((16 & this.bitmap$0$2) === 0)) {
    this.inline$minusblock$2 = this.$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("inline-block", new $c_Lscalatags_JsDom$GenericStyle().init___());
    this.bitmap$0$2 = (16 | this.bitmap$0$2)
  };
  return this.inline$minusblock$2
});
...
/** @constructor */
function $c_Lscalatags_generic_Styles$margin$() {
  $c_Lscalatags_generic_PixelStyle.call(this);
  this.auto$2 = null;
  this.$$outer$2 = null;
  this.bitmap$0$2 = false
...
$c_Lscalatags_generic_Styles$margin$.prototype.init___Lscalatags_generic_Styles = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  $c_Lscalatags_generic_PixelStyle.prototype.init___T__T.call(this, "margin", "margin");
  return this
});
...
/** @constructor */
function $c_Lscalatags_generic_Styles$position$() {
  $c_Lscalatags_generic_Style.call(this);
  this.static$2 = null;
  this.relative$2 = null;
  this.absolute$2 = null;
  this.fixed$2 = null;
  this.$$outer$2 = null;
  this.bitmap$0$2 = 0
}
...
$c_Lscalatags_generic_Styles$position$.prototype.absolute__Lscalatags_generic_StylePair = (function() {
  return (((4 & this.bitmap$0$2) === 0) ? this.absolute$lzycompute__p2__Lscalatags_generic_StylePair() : this.absolute$2)
});
$c_Lscalatags_generic_Styles$position$.prototype.init___Lscalatags_generic_Styles = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  $c_Lscalatags_generic_Style.prototype.init___T__T.call(this, "position", "position");
  return this
});
$c_Lscalatags_generic_Styles$position$.prototype.absolute$lzycompute__p2__Lscalatags_generic_StylePair = (function() {
  if (((4 & this.bitmap$0$2) === 0)) {
    this.absolute$2 = this.$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("absolute", new $c_Lscalatags_JsDom$GenericStyle().init___());
    this.bitmap$0$2 = (4 | this.bitmap$0$2)
  };
  return this.absolute$2
});
...
$c_Lscalatags_JsDom$styles$.prototype.textAlign__Lscalatags_generic_Styles$TextAlign = (function() {
  ...
  var hi = ((-2147483648) & b.hi$2);
  if ((hi === 0)) {
    return this.textAlign$lzycompute__p1__Lscalatags_generic_Styles$TextAlign()
  } else {
    return this.textAlign$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.init___ = (function() {
  return this
});
$c_Lscalatags_JsDom$styles$.prototype.border__Lscalatags_generic_Style = (function() {
  ...
  var lo = (16384 & b.lo$2);
  if ((lo === 0)) {
    return this.border$lzycompute__p1__Lscalatags_generic_Style()
  } else {
...
$c_Lscalatags_JsDom$styles$.prototype.left__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  ...
  var hi = (256 & b.hi$2);
  if ((hi === 0)) {
    return this.left$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle()
  } else {
    return this.left$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.height__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  ...
  var hi = (1 & b.hi$2);
  if ((hi === 0)) {
    return this.height$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle()
  } else {
    return this.height$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.margin$lzycompute__p1__Lscalatags_generic_Styles$margin$ = (function() {
  if ((this.margin$module$1 === null)) {
    this.margin$module$1 = new $c_Lscalatags_generic_Styles$margin$().init___Lscalatags_generic_Styles(this)
  };
  return this.margin$module$1
});
$c_Lscalatags_JsDom$styles$.prototype.backgroundColor$lzycompute__p1__Lscalatags_generic_Style = (function() {
  var b = this.bitmap$0$1;
  var lo = (8 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.right$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  var b = this.bitmap$0$1;
  var hi = (64 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.top__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  ...
  if ((hi === 0)) {
    return this.top$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle()
  } else {
    return this.top$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.display$lzycompute__p1__Lscalatags_generic_Styles$display$ = (function() {
  if ((this.display$module$1 === null)) {
    this.display$module$1 = new $c_Lscalatags_generic_Styles$display$().init___Lscalatags_generic_Styles(this)
  };
  return this.display$module$1
});
$c_Lscalatags_JsDom$styles$.prototype.bottom$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  var b = this.bitmap$0$1;
...
$c_Lscalatags_JsDom$styles$.prototype.bottom__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  ...
  var hi = (4194304 & b.hi$2);
  if ((hi === 0)) {
    return this.bottom$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle()
  } else {
    return this.bottom$1
  }
});
...
$c_Lscalatags_JsDom$styles$.prototype.width__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  ...
  if ((hi === 0)) {
    return this.width$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle()
  } else {
    return this.width$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.width$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  var b = this.bitmap$0$1;
  var hi = (2097152 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.backgroundColor__Lscalatags_generic_Style = (function() {
  ...
  var lo = (8 & b.lo$2);
  if ((lo === 0)) {
    return this.backgroundColor$lzycompute__p1__Lscalatags_generic_Style()
  } else {
    return this.backgroundColor$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.right__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  ...
  var hi = (64 & b.hi$2);
  if ((hi === 0)) {
    return this.right$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle()
  } else {
    return this.right$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.position$lzycompute__p1__Lscalatags_generic_Styles$position$ = (function() {
  if ((this.position$module$1 === null)) {
    this.position$module$1 = new $c_Lscalatags_generic_Styles$position$().init___Lscalatags_generic_Styles(this)
  };
  return this.position$module$1
});
$c_Lscalatags_JsDom$styles$.prototype.height$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  var b = this.bitmap$0$1;
  var hi = (1 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.border$lzycompute__p1__Lscalatags_generic_Style = (function() {
  var b = this.bitmap$0$1;
  var lo = (16384 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.zIndex__Lscalatags_generic_StyleMisc$AutoStyle = (function() {
  ...
  var lo = (256 & b.lo$2);
  if ((lo === 0)) {
    return this.zIndex$lzycompute__p1__Lscalatags_generic_StyleMisc$AutoStyle()
  } else {
    return this.zIndex$1
  }
});
$c_Lscalatags_JsDom$styles$.prototype.textAlign$lzycompute__p1__Lscalatags_generic_Styles$TextAlign = (function() {
  var b = this.bitmap$0$1;
  var hi = ((-2147483648) & b.hi$2);
  if ((hi === 0)) {
    ...
    var b$1 = this.bitmap$0$1;
    var lo = b$1.lo$2;
    var hi$1 = ((-2147483648) | b$1.hi$2);
    this.bitmap$0$1 = new $c_sjsr_RuntimeLong().init___I__I(lo, hi$1)
  };
  return this.textAlign$1
});
$c_Lscalatags_JsDom$styles$.prototype.top$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  var b = this.bitmap$0$1;
  var hi = (1048576 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.left$lzycompute__p1__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  var b = this.bitmap$0$1;
  var hi = (256 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.zIndex$lzycompute__p1__Lscalatags_generic_StyleMisc$AutoStyle = (function() {
  var b = this.bitmap$1$1;
  var lo = (256 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$styles$.prototype.margin__Lscalatags_generic_Styles$margin$ = (function() {
  return ((this.margin$module$1 === null) ? this.margin$lzycompute__p1__Lscalatags_generic_Styles$margin$() : this.margin$module$1)
});
...
var $n_Lscalatags_JsDom$styles$ = (void 0);
function $m_Lscalatags_JsDom$styles$() {
  if ((!$n_Lscalatags_JsDom$styles$)) {
    $n_Lscalatags_JsDom$styles$ = new $c_Lscalatags_JsDom$styles$().init___()
  };
...
$c_Lscalatags_JsDom$tags$.prototype.span$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var hi = (256 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$tags$.prototype.init___ = (function() {
  return this
});
$c_Lscalatags_JsDom$tags$.prototype.label$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (64 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
...
$c_Lscalatags_JsDom$tags$.prototype.input__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (128 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$tags$.prototype.span__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var hi = (256 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$tags$.prototype.label__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (64 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$tags$.prototype.div__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
...
$c_Lscalatags_JsDom$tags$.prototype.div$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (134217728 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
...
$c_Lscalatags_JsDom$tags$.prototype.input$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (128 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
...
var $n_Lscalatags_JsDom$tags$ = (void 0);
function $m_Lscalatags_JsDom$tags$() {
  if ((!$n_Lscalatags_JsDom$tags$)) {
    $n_Lscalatags_JsDom$tags$ = new $c_Lscalatags_JsDom$tags$().init___()
  };
...
$c_Lscalatags_generic_Styles$$anon$5.prototype.right__Lscalatags_generic_StylePair = (function() {
  return (((8 & this.bitmap$0$2) === 0) ? this.right$lzycompute__p2__Lscalatags_generic_StylePair() : this.right$2)
});
$c_Lscalatags_generic_Styles$$anon$5.prototype.right$lzycompute__p2__Lscalatags_generic_StylePair = (function() {
  if (((8 & this.bitmap$0$2) === 0)) {
    this.right$2 = $s_Lscalatags_generic_Styles$TextAlign$class__right__Lscalatags_generic_Styles$TextAlign__Lscalatags_generic_StylePair(this);
...
$c_Lobservatory_Implicits$.prototype.init___ = (function() {
...
var $n_Lobservatory_Implicits$ = (void 0);
function $m_Lobservatory_Implicits$() {
  if ((!$n_Lobservatory_Implicits$)) {
    $n_Lobservatory_Implicits$ = new $c_Lobservatory_Implicits$().init___()
  };
...
$c_Lscalatags_JsDom$attrs$.prototype.max__Lscalatags_generic_Attr = (function() {
  ...
  var hi = (1024 & b.hi$2);
  if ((hi === 0)) {
    return this.max$lzycompute__p1__Lscalatags_generic_Attr()
  } else {
    return this.max$1
  }
});
$c_Lscalatags_JsDom$attrs$.prototype.init___ = (function() {
...
$c_Lscalatags_JsDom$attrs$.prototype.min__Lscalatags_generic_Attr = (function() {
  ...
  var hi = (2048 & b.hi$2);
  if ((hi === 0)) {
    return this.min$lzycompute__p1__Lscalatags_generic_Attr()
  } else {
    return this.min$1
  }
});
$c_Lscalatags_JsDom$attrs$.prototype.name__Lscalatags_generic_Attr = (function() {
  ...
  var hi = (32768 & b.hi$2);
  if ((hi === 0)) {
    return this.name$lzycompute__p1__Lscalatags_generic_Attr()
  } else {
    return this.name$1
  }
});
$c_Lscalatags_JsDom$attrs$.prototype.max$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$1$1;
  var hi = (1024 & b.hi$2);
  if ((hi === 0)) {
    this.max$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this, "max", null, false);
    var b$1 = this.bitmap$1$1;
    var lo = b$1.lo$2;
...
$c_Lscalatags_JsDom$attrs$.prototype.name$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$1$1;
  var hi = (32768 & b.hi$2);
  if ((hi === 0)) {
    this.name$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this, "name", null, false);
    var b$1 = this.bitmap$1$1;
    var lo = b$1.lo$2;
    var hi$1 = (32768 | b$1.hi$2);
    this.bitmap$1$1 = new $c_sjsr_RuntimeLong().init___I__I(lo, hi$1)
  };
  return this.name$1
});
$c_Lscalatags_JsDom$attrs$.prototype.value$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$1$1;
  var hi = (33554432 & b.hi$2);
  if ((hi === 0)) {
    this.value$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this, "value", null, false);
    var b$1 = this.bitmap$1$1;
    var lo = b$1.lo$2;
...
$c_Lscalatags_JsDom$attrs$.prototype.onchange__Lscalatags_generic_Attr = (function() {
  ...
  if ((lo === 0)) {
    return this.onchange$lzycompute__p1__Lscalatags_generic_Attr()
  } else {
...
$c_Lscalatags_JsDom$attrs$.prototype.value__Lscalatags_generic_Attr = (function() {
  ...
  var hi = (33554432 & b.hi$2);
  if ((hi === 0)) {
    return this.value$lzycompute__p1__Lscalatags_generic_Attr()
  } else {
    return this.value$1
  }
});
$c_Lscalatags_JsDom$attrs$.prototype.type$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$1$1;
...
$c_Lscalatags_JsDom$attrs$.prototype.min$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$1$1;
  var hi = (2048 & b.hi$2);
  if ((hi === 0)) {
    this.min$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this, "min", null, false);
    var b$1 = this.bitmap$1$1;
    var lo = b$1.lo$2;
...
$c_Lscalatags_JsDom$attrs$.prototype.checked$lzycompute__p1__Lscalatags_generic_AttrPair = (function() {
  var b = this.bitmap$1$1;
  var hi = (1 & b.hi$2);
  if ((hi === 0)) {
    this.checked$1 = $s_Lscalatags_generic_InputAttrs$class__checked__Lscalatags_generic_InputAttrs__Lscalatags_generic_AttrPair(this);
    var b$1 = this.bitmap$1$1;
    var lo = b$1.lo$2;
    var hi$1 = (1 | b$1.hi$2);
    this.bitmap$1$1 = new $c_sjsr_RuntimeLong().init___I__I(lo, hi$1)
...
$c_Lscalatags_JsDom$attrs$.prototype.onchange$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$0$1;
  var lo = (8388608 & b.lo$2);
  if ((lo === 0)) {
    this.onchange$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this, "onchange", null, false);
    var b$1 = this.bitmap$0$1;
...
$c_Lscalatags_JsDom$attrs$.prototype.onclick$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$0$1;
  var hi = (32768 & b.hi$2);
  if ((hi === 0)) {
...
$c_Lscalatags_JsDom$attrs$.prototype.checked__Lscalatags_generic_AttrPair = (function() {
  ...
  var hi = (1 & b.hi$2);
  if ((hi === 0)) {
    return this.checked$lzycompute__p1__Lscalatags_generic_AttrPair()
  } else {
    return this.checked$1
  }
});
...
var $n_Lscalatags_JsDom$attrs$ = (void 0);
function $m_Lscalatags_JsDom$attrs$() {
  if ((!$n_Lscalatags_JsDom$attrs$)) {
    $n_Lscalatags_JsDom$attrs$ = new $c_Lscalatags_JsDom$attrs$().init___()
  };
